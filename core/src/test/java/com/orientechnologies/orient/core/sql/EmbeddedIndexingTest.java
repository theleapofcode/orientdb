...
public class EmbeddedIndexingTest {
  ...
  private static void createPersonSchema() {
    ...
    db.command(
        new OCommandSQL("CREATE index person_mobileslist on person (`mobileslist.mobileNumber`) NOTUNIQUE STRING"))
        .execute();
    db.command(new OCommandSQL("CREATE index person_mobilesset on person (`mobilesset.mobileNumber`) NOTUNIQUE STRING"))
        .execute();
    db.command(new OCommandSQL(
        "CREATE index person_mobilesmap on person (`mobilesmap[personal].mobileNumber`) NOTUNIQUE STRING")).execute(); // Indexed
                                                                                                                       // on
                                                                                                                       // value
                                                                                                                       // of
                                                                                                                       // particular
  ...
  private static void createDemoSchema() {
    ...
    db.command(new OCommandSQL("CREATE index demo_emap on demo (`emap[homeAddress].city`) NOTUNIQUE STRING")).execute();
  }
  ...
  public void testLinkList() throws Exception {
    ...
    List<ODocument> qResult = db
        .command(new OCommandSQL("select * from person where mobileslist.mobileNumber contains '111'")).execute();
    Assert.assertEquals(qResult.size(), 1);
  ...
  public void testLinkSet() throws Exception {
    ...
    List<ODocument> qResult = db.command(new OCommandSQL("select * from person where mobilesset.mobileNumber in '111'"))
        .execute();
    Assert.assertEquals(qResult.size(), 1);
  ...
  public void testLinkMap() throws Exception {
    ...
    List<ODocument> qResult = db
        .command(new OCommandSQL("select * from person where mobilesmap[personal].mobileNumber='111'")).execute();
    Assert.assertEquals(qResult.size(), 1);
  ...
  public void testEmbeddedWithLinkedClassOnUpdate() throws Exception {
    ...
    List<ODocument> qResult2 = db.command(new OCommandSQL("select * from foo where address.city = 'CHE'")).execute();
    Assert.assertEquals(qResult2.size(), 0);
    long idxUsages4 = indexUsages();
    Assert.assertEquals(idxUsages3 + 1, idxUsages4);

    List<ODocument> qResult3 = db.command(new OCommandSQL("select * from foo where address.city = 'BLR'")).execute();
  ...
  public void testEmbeddedWithoutLinkedClassOnUpdate() throws Exception {
    ...
    long idxUsages3 = indexUsages();
    List<ODocument> qResult2 = db.command(new OCommandSQL("select * from foo where xyz.asd.zxc = 'val3'")).execute();
    Assert.assertEquals(qResult2.size(), 0);
    long idxUsages4 = indexUsages();
    Assert.assertEquals(idxUsages3 + 1, idxUsages4);

    List<ODocument> qResult3 = db.command(new OCommandSQL("select * from foo where xyz.asd.zxc = 'val4'")).execute();
    Assert.assertEquals(qResult3.size(), 1);
    long idxUsages5 = indexUsages();
    Assert.assertEquals(idxUsages4 + 1, idxUsages5);
  }
  ...
  public void testEmbeddedListOfPrimitivesOnUpdate() throws Exception {
    ...
    db.command(
        new OCommandSQL("update test set eliststr= ['elistval10', 'elistval11', 'elistval12'] where name='test3'"))
        .execute();
    ...
    List<ODocument> qResult3 = db.command(new OCommandSQL("select * from test where eliststr contains 'elistval10'"))
        .execute();
    Assert.assertEquals(qResult3.size(), 1);
    long idxUsages5 = indexUsages();
    Assert.assertEquals(idxUsages4 + 1, idxUsages5);
  ...
  public void testEmbeddedSetOfPrimitivesOnUpdate() throws Exception {
    ...
    db.command(new OCommandSQL("update test set esetstr= ['esetval10', 'esetval11', 'esetval12'] where name='test3'"))
        .execute();
  ...
  public void testEmbeddedMapOfPrimitives() throws Exception {
    ...
    List<ODocument> qResult = db
        .command(new OCommandSQL("select * from test where emapstr containsvalue 'v1' and emapstr[k1]='v1'")).execute();
    Assert.assertEquals(qResult.size(), 1);
  ...
  public void testEmbeddedMapOfPrimitivesOnUpdate() throws Exception {
    ...
    List<ODocument> qResult = db
        .command(new OCommandSQL("select * from test where emapstr containsvalue 'v5' and emapstr[k1]='v5'")).execute();
    Assert.assertEquals(qResult.size(), 1);
    long idxUsages2 = indexUsages();
    Assert.assertEquals(idxUsages1 + 1, idxUsages2);
    ...
    List<ODocument> qResult3 = db
        .command(new OCommandSQL("select * from test where emapstr containsvalue 'v7' and emapstr[k1]='v7'")).execute();
    Assert.assertEquals(qResult3.size(), 1);
    long idxUsages5 = indexUsages();
    Assert.assertEquals(idxUsages4 + 1, idxUsages5);
  }
